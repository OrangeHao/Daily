 ...
 */
package com.orange.module_collector.widget;
...
public class CheckView extends View {
    ...
    private void init(Context context,AttributeSet attrs) {
        ...
        if (attrs!=null){
            TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.module_collector_CheckView);
            color  = typedArray.getColor(R.styleable.module_collector_CheckView_background_color,color);
            typedArray.recycle();
        }
        ...
        mCheckDrawable = ResourcesCompat.getDrawable(context.getResources(),
                R.drawable.module_collector_ic_check_white_18dp, context.getTheme());
    }
    ...
    private void initBackgroundPaint() {
        if (mBackgroundPaint == null) {
            ...
            TypedArray ta = getContext().getTheme()
                    .obtainStyledAttributes(new int[]{R.attr.background_color});
